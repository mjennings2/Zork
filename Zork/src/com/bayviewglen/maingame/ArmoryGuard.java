		...
		if (isTerrorist) {
			while (loop) {
				...
				if (!questions[1]) {
					displayTextMilitaryStyle(x,
							"2 What are you planning to do in San Francisco?\n");
				}
				if (!questions[2]) {
				...
				if (input == 1) {
					displayTextMilitaryStyle(x,
							"\"EXCUUUUUUUUUUUUUUUSE ME? I AM NO TRAITOR!\"\n");
					questions[0] = true;
				} else if (input == 2) {
					...
					displayTextMilitaryStyle(x,
							"\"I don't have, nor do I need kids.\"\n");
					questions[2] = true;
				} else {
					loop = false;
				}
			...
			while (loop) {
				if (!questions[0]) {
					...
					if (!questions[1]) {
						displayTextMilitaryStyle(x,
								"2 What are you planning to do in San Fransisco?\n");
					}
					if (questions[2]) {
						displayTextMilitaryStyle(x, "3 How are the kids.\n");
					}
